...
(function () {
  ...
  function arrangeStack() {
    ...
    Object.keys(byCorner).forEach(function (corner) {
      ...
      // Each widget ships its own left/right value (Silktide's icon sits
      // closer to the edge than ours, for example). Re-assert the same
      // horizontal offset on every stacked widget so they line up vertically
      // regardless of who set what.
